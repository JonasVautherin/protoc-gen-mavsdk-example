...
# ObjC++
protoc some_api.proto --plugin=protoc-gen-custom=$(which protoc-gen-mavsdk) -I. --custom_out=. --custom_opt=output_file=swift/ExampleLibrary/Sources/ExampleLibraryObjC/include/SomeApiObjC.h --custom_opt=template_file=swift/ExampleLibrary/Sources/ExampleLibraryObjC/include/SomeApiObjC.h.j2 --custom_opt=lstrip_blocks=True --custom_opt=trim_blocks=True
protoc some_api.proto --plugin=protoc-gen-custom=$(which protoc-gen-mavsdk) -I. --custom_out=. --custom_opt=output_file=swift/ExampleLibrary/Sources/ExampleLibraryObjC/SomeApiObjC.mm --custom_opt=template_file=swift/ExampleLibrary/Sources/ExampleLibraryObjC/SomeApiObjC.mm.j2 --custom_opt=lstrip_blocks=True --custom_opt=trim_blocks=True
